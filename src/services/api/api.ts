...
class Api {
    ...
    get<T>(endpoint: string, auth = false): Promise<T> {
        try {
            return new Promise((resolve, reject) => {
                ...
                axios.get<T>(this.env.API_URL + endpoint).then((response: any) => {
    ...
    //         axios.get<T>(this.env.API_URL + endpoint, headers).then((response: any) => {
    //           resolve(<T>response.data);
    //         }).catch((err: any) => {
    //           this.apiError(err.response.data);
    //           reject(err.response.data);
    ...
    post<T>(endpoint: string, data: any, auth = false, withImage = false): Promise<T> {
        return new Promise((resolve: any, reject: any) => {
            ...
            axios.post<T>(this.env.API_URL + endpoint, data).then((response: any) => {
                resolve(<T>response.data);
            }).catch((err: any) => {
                this.apiError(err.response.data);
                reject(err.response.data);
    ...
    //       axios.post<T>(this.env.API_URL + endpoint, data, headers).then((response: any) => {
    //         resolve(<T>response.data);
    //       }).catch((err: any) => {
    //         this.apiError(err.response.data);
    //         reject(err.response.data);
    ...
    async put<T>(endpoint: string, data: any, auth = false) {
        try {
            const headers = await this.headers(auth, endpoint);
            const response = await axios.put<T>(this.env.API_URL + endpoint, data, headers);
    ...
    async delete<T>(endpoint: string, auth = false) {
        try {
            const headers = await this.headers(auth, endpoint);
            const response = await axios.delete<T>(this.env.API_URL + endpoint, headers);
            return <T>response.data;
        } catch (e) {
            await this.apiError(e);
            throw e;
